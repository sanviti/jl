...
class JPush {
    ...
    const DEFAULT_LOG_FILE = "./Application/Runtime/Logs/Jpush/jpush.log";
    const HTTP_GET = 'GET';
    ...
    public function __construct($appKey="a10e71bd4bdf7d45d132b47a", $masterSecret="2cd118d7fc72c37a169ba6ad", $logFile=self::DEFAULT_LOG_FILE, $retryTimes=self::DEFAULT_MAX_RETRY_TIMES) {
